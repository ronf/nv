...
static void PIP_GrabColor(uint8 *y_data, uint8 *uv_data)
{
    int x, y;
...
static int PIP_GrabFrame(uint8 *y_data, uint8 *uv_data)
{
    int err=0;
...
/*ARGSUSED*/
grabproc_t *PIP_Start(int min_framespacing, int config, reconfigproc_t *r,
		      void *e)
{
